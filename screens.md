...
- **[P] 안내 종료 확인**
  - **Prompt**: `Design a confirmation popup to end navigation. Clean white card with 'Stop' and 'Continue' options.`

## 7. 🌐 홍보 및 웹 사이트
- **[W] 서비스 소개 홈페이지 (Landing Page)**
  - **Prompt**: `Design a high-end, interactive SaaS-style landing page for 'Ratip'. Features a massive hero section with the 3D crystal compass logo and a floating 3D iPhone mockup. **Implement a 'Scroll-to-Reveal' storytelling layout where app features and descriptions (Map, Achievements, Events) animate into view as the user scrolls down.** Use parallax effects, smooth scroll-triggered animations, and a white glassmorphism aesthetic with Indigo (#6366F1) gradients. The page should feel like a journey, revealing more detail about the 'Path' and 'Record' philosophy with every scroll. High-end, futuristic, and extremely polished.`

---
**범례**: `[S]` = Full Screen, `[P]` = Popup/Dialog, `[B]` = Bottom Sheet, `[U]` = UI Overlay, `[W]` = Web Page
